...
export default function HifzStep2Impregnation({ surahNumber, startVerse, endVerse, onNext, onBack, onPause }: Props) {
  ...
  return (
    <HifzStepWrapper stepNumber={2} stepTitle="Imprégnation & Sens" onBack={onBack} onPause={onPause} surahNumber={surahNumber} startVerse={startVerse} endVerse={endVerse}>
