...
export const dailyQuotes: DailyQuote[] = [
  ...
  { theme: '🌿', type: 'citation', text: "Un petit pas chaque jour avec Allah vaut mieux qu'un grand bond sans lendemain." },
  ...
  { theme: '📖', type: 'citation', text: "Chaque révision est une preuve d'amour envers la Parole d'Allah." },
  ...
  // 🤲 Invocations (Douas)
  { theme: '🤲', type: 'doua', text: "Ô Allah, fais du Coran le printemps de mon cœur et la lumière de ma poitrine." },
  { theme: '🤲', type: 'doua', text: "Seigneur, augmente mes connaissances et facilite mon chemin vers Ta Parole." },
  { theme: '🤲', type: 'doua', text: "Ô Allah, aide-moi à T'évoquer, à Te remercier et à T'adorer avec excellence." },
  { theme: '🤲', type: 'doua', text: "Seigneur, ouvre-moi ma poitrine et facilite ma tâche." },
  { theme: '🤲', type: 'doua', text: "Ô Allah, je Te demande une science utile et un cœur humble." },
  { theme: '🤲', type: 'doua', text: "Seigneur, affermis ma mémoire et purifie mon intention dans chaque verset." },
  { theme: '🤲', type: 'doua', text: "Ô Allah, enseigne-moi ce que j'ignore et rappelle-moi ce que j'ai oublié." },
  { theme: '🤲', type: 'doua', text: "Seigneur, fais que je sois parmi les gens du Coran, ceux qui sont Tes proches et Tes élus." },
  { theme: '🤲', type: 'doua', text: "Ô Allah, facilite-moi l'ascension de Tes escaliers par la récitation de Tes versets." },
