...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/quran-reader" element={<ProtectedRoute><ComingSoonGate title="Le Noble Coran" icon={BookOpen} description="Lis et médite le Coran avec un Mushaf interactif." hideNav>{<QuranReaderPage />}</ComingSoonGate></ProtectedRoute>} />
