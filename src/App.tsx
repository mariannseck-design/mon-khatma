...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/hifz-suivi-a" element={<ProtectedRoute><SuiviHifz_PageA /></ProtectedRoute>} />
      <Route path="/hifz-suivi-b" element={<ProtectedRoute><SuiviHifz_PageB /></ProtectedRoute>} />
